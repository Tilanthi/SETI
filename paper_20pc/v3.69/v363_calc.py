...
M('PbFloorResp', '0.5')            # response floor adopted in v3.69
...
# interval is an order of magnitude wider.  `tailboot_v369.py` recomputes the
...
_TB = json.load(open('tailboot_v369.json'))
...
# stated in the text.
_CM = json.load(open('campaign_v369.json'))
