...
# v3.46 single-source repair: the occurrence and duty quantities were read from
...
M = [
 ...
 ('NRankFirst',           '%d' % S['n_sbr']),
 ('RateRankFirst',        '%.1f' % (100 * S['rate_sbr'])),
 ('RateRankFirstOld',     '%.1f' % (100 * S['rate_sbr_old'])),
 ('NRankFirstOld',        '%d' % S['n_sbr_old']),
 ...
 ('RecTwice',       '83'),
 ('NTrials',        '1200'),
 # v3.46: Bands 6+7 share of searched windows.  Was hand-typed as '83 per
