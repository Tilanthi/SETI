...
GROSS_BW = 700.8                  # tab:exposure, gross searched bandwidth
...
# \EffBandGHz (87, round-1 generator) conflicts with the tab:maskband
# union arithmetic (93.1 - 4.96 = 88.2); the generated mask-band table is
# the later, band-decomposed authority, so the macro is renewed here.
macros.append('\\renewcommand{\\EffBandGHz}{%s}'
              % ('%.1f' % (union - MASK_UNION_LOST)))
