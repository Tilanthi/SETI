#!/usr/bin/env python3
"""v3.51 generator -> survey_numbers_round19.tex
...
ROWS = list(csv.DictReader(open(os.path.join(HERE, 'per_target_results_v3.51.csv'))))
F = float
...
# =====================================================================
HO = json.load(open(os.path.join(HERE, 'heldout_v351.json')))
W = HO['windows']
CAMP = HO['campaign_status']
det = [w for w in W if w['detection']]
...
M('HONewStars', '%d' % 2)           # HD 53143 and Wolf 359, neither a flagged star
