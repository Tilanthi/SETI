...
# too. Missing this shipped four rows of the v3.95 false-alarm table as
# "--": falsealarm_v395.py looks its inputs up by name with V('Name'), and
# occurrence_v395.py cross-asserts against published values the same way.
