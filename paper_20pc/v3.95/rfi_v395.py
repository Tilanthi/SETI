#!/usr/bin/env python3
"""R2-3 (v3.95): the RFI vetting statement for the unattributed events,
...
CAT = os.path.join(HERE, 'per_target_results_v3.95.csv')
...
json.dump(res, open(os.path.join(HERE, 'rfi_v395.json'), 'w'),
          indent=1, sort_keys=True, default=str)

L = ['%% GENERATED by rfi_v395.py -- do not hand-edit.\n']
