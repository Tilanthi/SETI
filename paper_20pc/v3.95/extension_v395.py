#!/usr/bin/env python3
"""v3.95: the prospective epoch extension.
...
json.dump(res, open(os.path.join(HERE, 'extension_v395.json'), 'w'),
          indent=1, default=str)

L = ['%% GENERATED by extension_v395.py -- do not hand-edit.\n']
...
open(os.path.join(HERE, 'tab_extension_v395.tex'), 'w').write('\n'.join(T) + '\n')

print('%s: %d macros; tab_extension_v395.tex written'
