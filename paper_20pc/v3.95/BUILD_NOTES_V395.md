# v3.95 — the readability and compression round
...
`xrefcheck` 0 misplaced labels, `consistency_v395` 0, `macroleak` 0.
...
2. **A silently weakened gate.** Rewording *"we do not adopt the
   ...
   `consistency_v395.py`'s detector, which then reported *"no explicit
