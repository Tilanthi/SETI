#!/usr/bin/env python3
"""R2-5 (v3.95): robustness of the dispositions to the line-mask half-width,
as a table.
...
(falsealarm_v395.py, primary_v395.py, make_vistest_events_v385.py all test
...
Writes survey_numbers_round59.tex and tab_maskrobust_v395.tex.
"""
import csv
import os
...
TAB = os.path.join(HERE, 'tab_maskrobust_v395.tex')
...
with open(TAB, 'w') as f:
    f.write('%% GENERATED by maskrobust_v395.py -- do not hand-edit.\n')
