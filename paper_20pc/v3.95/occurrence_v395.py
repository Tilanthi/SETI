#!/usr/bin/env python3
"""R2-2 (v3.95): the standard occurrence-rate metrics, computed.
...
json.dump(res, open(os.path.join(HERE, 'occurrence_v395.json'), 'w'),
...
L = ['%% generated by occurrence_v395.py -- do not edit\n']
