...
echo "--- generator/round-file ownership (v3.95: added after a silent overwrite) ---"
python3 roundcollide.py

echo "--- cross-reference resolution (R2-t2) ---"
python3 xrefcheck.py

echo "--- primary-statistic consistency (referee 2, v3.95) ---"
python3 consistency_v395.py

echo "--- macro leakage (referee 2, v3.95) ---"
