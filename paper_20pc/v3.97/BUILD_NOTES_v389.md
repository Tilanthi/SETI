# BUILD NOTES — v3.97: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V397.md` is the live ledger.
...
New `primary_v397.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v397.txt` ships the verbatim output of
