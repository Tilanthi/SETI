#!/usr/bin/env python3
"""R2-3 (v3.97): the RFI vetting statement for the unattributed events,
...
CAT = os.path.join(HERE, 'per_target_results_v3.97.csv')
...
assert len(UNATT) == 4, 'expected 4 unattributed events, got %d' % len(UNATT)
...
json.dump(res, open(os.path.join(HERE, 'rfi_v397.json'), 'w'),
          indent=1, sort_keys=True, default=str)

L = ['%% GENERATED by rfi_v397.py -- do not hand-edit.\n']
