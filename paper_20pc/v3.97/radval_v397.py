#!/usr/bin/env python3
"""R1-1 (v3.97): prospective, out-of-sample validation of the radius
...
json.dump(res, open(os.path.join(HERE, 'radval_v397.json'), 'w'), indent=1)

L = ['%% GENERATED by radval_v397.py -- do not hand-edit.\n']
