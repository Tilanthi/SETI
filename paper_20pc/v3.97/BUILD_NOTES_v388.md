# BUILD NOTES — v3.97: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v397.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v397.tex` |
...
* **The rename `v387` → `v397` left `tab_falsealarm_v387.tex` orphaned.**
