# v3.97 — the readability and compression round
...
`xrefcheck` 0 misplaced labels, `consistency_v397` 0, `macroleak` 0.
...
2. **A silently weakened gate.** Rewording *"we do not adopt the
   ...
   `consistency_v397.py`'s detector, which then reported *"no explicit
