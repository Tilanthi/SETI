...
# =====================================================================
# v3.85 (R2): this analysis can only rescore windows for which the frozen
# release stored a control vector, and the released stage-1 set it compares
# against is the subset within those. Emit the scope so the text states it
# instead of reading as a survey-wide result.
M('RmScopeWin', '%d' % RM['n'])
M('RmScopeReleased', '%d' % len(RM['released']))
