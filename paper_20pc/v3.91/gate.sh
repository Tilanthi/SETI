...
echo "--- generator/round-file ownership (v3.91: added after a silent overwrite) ---"
python3 roundcollide.py

echo "--- cross-reference resolution (R2-t2) ---"
python3 xrefcheck.py

echo "--- primary-statistic consistency (referee 2, v3.91) ---"
python3 consistency_v391.py
