# BUILD NOTES — v3.91: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V391.md` is the live ledger.
...
New `primary_v391.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v391.txt` ships the verbatim output of
