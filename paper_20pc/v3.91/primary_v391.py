#!/usr/bin/env python3
"""v3.91: the radius-corrected statistic becomes the PRIMARY analysis.
...
What this generator produces:
 ...
 2. The correctly conditioned null for the CORRECTED statistic. A stage-1
    ...
    pseudo-star tail factor and -- new in v3.91, at referee 2's request --
...
CAT = list(csv.DictReader(open(os.path.join(
    HERE, 'per_target_results_v3.91.csv'))))
...
json.dump(res, open(os.path.join(HERE, 'primary_v391.json'), 'w'), indent=1)

L = ['%% GENERATED by primary_v391.py -- do not hand-edit.\n']
