#!/usr/bin/env python3
"""R2-3 (v3.91): the RFI vetting statement for the unattributed events,
...
CAT = os.path.join(HERE, 'per_target_results_v3.91.csv')
...
json.dump(res, open(os.path.join(HERE, 'rfi_v391.json'), 'w'),
          indent=1, sort_keys=True, default=str)

L = ['%% GENERATED by rfi_v391.py -- do not hand-edit.\n']
