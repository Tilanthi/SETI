...
# R2-M7: the provenance table in the paper must quote the same commit and
# date this rule records, so emit them rather than letting the text repeat
# them by hand.
with open('survey_numbers_round71.tex', 'w') as _fh:
    _fh.write('%% GENERATED by apply_holdout_v381.py -- do not hand-edit.\n')
