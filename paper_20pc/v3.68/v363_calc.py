...
M('PbFloorResp', '0.5')            # response floor adopted in v3.68
...
# interval is an order of magnitude wider.  `tailboot_v368.py` recomputes the
...
_TB = json.load(open('tailboot_v368.json'))
