...
# BOTH counters, always.  abstract_limit.py counts the source with the
# generated macros expanded; abschars.py counts the typeset abstract out of the
# PDF.  Until v3.49 only the first ran, and it did not expand macros, so it
# reported 1907 while the real abstract was 1975 and over arXiv's hard limit.
