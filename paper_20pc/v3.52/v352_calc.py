#!/usr/bin/env python3
"""v3.52 generator -> survey_numbers_round20.tex

Single-sources the quantitative blocks the v3.52 cycle adds, so that nothing
...
Inputs (all frozen; all in this directory unless noted):
  ...
  technosignatures_20pc_v3.52.tex parsed, read-only, for the transfer bracket
...
_tex = open(os.path.join(HERE, 'technosignatures_20pc_v3.52.tex')).read()
