#!/usr/bin/env python3
"""Inventory: for every edit in the v3.52 EDITS lists, decide APPLIED / PENDING / AMBIG.
...
TEX = '/workspace/SETI/paper_20pc/v3.52/technosignatures_20pc_v3.52.tex'
...
json.dump([dict(zip(['file', 'id', 'lvl', 'state', 'cost', 'detail', 'title'], r)) for r in res],
          open('/workspace/SETI/paper_20pc/v3.52/inventory_v352.json', 'w'), indent=1)
