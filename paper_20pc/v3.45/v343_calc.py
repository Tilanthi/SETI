#!/usr/bin/env python3
"""Round-13 (v3.45) generated numbers.

Every quantity the three v3.45 referee reports showed to be hand-typed,
stale or contradicted by the shipped catalogue is recomputed here from
`per_target_results_v3.45.csv` (the released catalogue), the frozen export
...
CSV = HERE + '/per_target_results_v3.45.csv'
...
# Retired in the v3.45 cycle after the unused-macro sweep: AcaBeamRatio,
