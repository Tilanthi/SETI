# BUILD NOTES — v3.98: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V398.md` is the live ledger.
...
New `primary_v398.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v398.txt` ships the verbatim output of
