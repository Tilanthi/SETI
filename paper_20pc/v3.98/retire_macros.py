...
# too. Missing this shipped four rows of the v3.98 false-alarm table as
# "--": falsealarm_v398.py looks its inputs up by name with V('Name'), and
# occurrence_v398.py cross-asserts against published values the same way.
