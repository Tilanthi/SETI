#!/usr/bin/env python3
"""R2-3 (v3.98): the RFI vetting statement for the unattributed events,
...
json.dump(res, open(os.path.join(HERE, 'rfi_v398.json'), 'w'),
          indent=1, sort_keys=True, default=str)

L = ['%% GENERATED by rfi_v398.py -- do not hand-edit.\n']
