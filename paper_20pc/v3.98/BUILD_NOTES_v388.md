# BUILD NOTES — v3.98: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v398.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v398.tex` |
...
* **The rename `v387` → `v398` left `tab_falsealarm_v387.tex` orphaned.**
