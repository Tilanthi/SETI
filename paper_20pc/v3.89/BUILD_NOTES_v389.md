# BUILD NOTES — v3.89: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V389.md` is the live ledger.
...
New `primary_v389.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v389.txt` ships the verbatim output of
