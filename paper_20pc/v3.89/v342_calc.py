...
COLS = ['star_name', 'system_id', 'band', 'eb', 'dist_pc', 'flo_GHz', 'fhi_GHz',
        ...
        'disposition']
with open('per_target_results_v3.89.csv', 'w', newline='') as fh:
    w = csv.writer(fh)
    w.writerow(COLS)
...
with open('per_target_results_v3.89.csv') as _fh:
...
print('catalogue -> per_target_results_v3.89.csv (%d rows, %d columns)'
      % (len(GOOD), len(COLS)))
