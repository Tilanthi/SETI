# BUILD NOTES — v3.89: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v389.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v389.tex` |
...
* **The rename `v387` → `v389` left `tab_falsealarm_v387.tex` orphaned.**
