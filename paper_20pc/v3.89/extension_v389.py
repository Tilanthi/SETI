#!/usr/bin/env python3
"""v3.89: the prospective epoch extension.
...
json.dump(res, open(os.path.join(HERE, 'extension_v389.json'), 'w'),
          indent=1, default=str)

L = ['%% GENERATED by extension_v389.py -- do not hand-edit.\n']
...
open(os.path.join(HERE, 'tab_extension_v389.tex'), 'w').write('\n'.join(T) + '\n')

print('%s: %d macros; tab_extension_v389.tex written'
