...
# too. Missing this shipped four rows of the v3.89 false-alarm table as
# "--": falsealarm_v389.py looks its inputs up by name with V('Name'), and
# occurrence_v389.py cross-asserts against published values the same way.
