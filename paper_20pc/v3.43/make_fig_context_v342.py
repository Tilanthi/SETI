#!/usr/bin/env python3
# v3.43 page-trim variant: Figure 1 panels side by side, fonts rescaled for 1:1
...
DEFAULT_DATA = os.path.join(HERE, "frozen_export_v3.31.json")  # v3.43: local copy;
...
def save(fig, path):
    # v3.43: tight bbox for the side-by-side Fig. 1 so no label is clipped.
...
def main():
    ...
    p2 = p1  # completeness_surface is not used in v3.43
