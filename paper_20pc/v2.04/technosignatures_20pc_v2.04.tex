...
Table~\ref{tab:full} (Appendix~\ref{app:table}). The 19 target/bands
processed under the earlier, single-window pipeline are being
reprocessed under the extended one as the survey continues; for these,
Table~\ref{tab:full} still shows only the originally-searched window,
...
limit) together with the underlying map rms noise. As described in
\S\ref{sec:method}, the pipeline was extended during the preparation of
this version to search every distinct configured spectral window (not
only the single finest-resolution one, as in earlier versions of this
paper), and each searched window will appear as its own row once
processed; the 19 target/bands in the table below were searched before
this extension and are being reprocessed under the new, multi-window
pipeline (\S\ref{sec:sample}), so only their originally-searched window
is shown for now, explicitly flagged in the Notes column. This table will
...
simultaneously in the observation; EIRP$_{\rm min}$ is in W. Flux is the
measured peak continuum flux density for a detection, or the resulting
$5\sigma$ upper limit (denoted ``$<$''); RMS is the underlying continuum
image rms noise; both in mJy. The one automatically-flagged
...
NAME Barnard's star & 7 & M5V & 1.83 & \ldots & 6 & \ldots & $<$3.622 & 0.7243 & narrowband search failed; reprocessing queued \\
Wolf  359 & 7 & M6V & 2.41 & \ldots & 7 & \ldots & $<$3.380 & 0.6761 & narrowband search failed; reprocessing queued \\
Sirius B & 3 & DA2 & 2.67 & 92.13--93.86 & 4 & 2.56e+13 & $<$0.189 & 0.0379 & reprocessing queued (other spws) \\
Sirius B & 4 & DA2 & 2.67 & 142.13--143.86 & 4 & 2.31e+13 & $<$0.247 & 0.0493 & reprocessing queued (other spws) \\
Sirius B & 5 & DA2 & 2.67 & 195.13--196.86 & 4 & 3.48e+13 & $<$0.455 & 0.0911 & reprocessing queued (other spws) \\
...
tau Cet & 6 & K0V & 3.65 & 229.63--231.47 & 24 & 3.79e+13 & 0.863 & 0.1066 & reprocessing queued (other spws) \\
GJ 674 & 6 & M3V & 4.55 & 223.09--224.91 & 4 & 2.74e+14 & $<$0.516 & 0.1032 & reprocessing queued (other spws) \\
GJ 581 & 6 & M4V & 6.30 & 223.09--224.91 & 4 & 6.35e+14 & $<$0.451 & 0.0903 & reprocessing queued (other spws) \\
