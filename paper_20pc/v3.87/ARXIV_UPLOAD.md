...
0 Type 3 fonts, 0 missing files, **29 pages**, two-column OJA layout.
12 underfull boxes, all short lines in the narrow two-column measure.

**46 items** (38 tex/cls/sty + 9 figures). The `.tex` carries no author
`%` comments; the outstanding author questions are in `AUTHOR_ACTIONS.md`.

Abstract: **1857 rendered characters** against arXiv's hard limit of 1920.
...
- `tab_perband.tex`
- `tab_selection.tex`
- `technosignatures_40pc_v3.62.tex`
