...
# too. Missing this shipped four rows of the v3.87 false-alarm table as
# "--": falsealarm_v387.py looks its inputs up by name with V('Name'), and
# occurrence_v387.py cross-asserts against published values the same way.
