...
Inputs (all frozen; all in this directory unless noted):
  ...
  per_target_results_v3.87.csv    the released catalogue (431 windows)
...
F = float
ROWS = list(csv.DictReader(open(os.path.join(HERE, 'per_target_results_v3.87.csv'))))
...
CATALOGUE_FILE = 'per_target_results_v3.87.csv'
