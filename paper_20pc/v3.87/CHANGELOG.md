...
folder, and this file was not kept up. Noted at v3.87 rather than
reconstructed, since the per-version notes are the primary record and are
complete.

## v3.87 (2026-09-21) — two referee reports, 26 recommendations, none declined

Full notes: `BUILD_NOTES_v387.md`. Letter: `REFEREE_RESPONSE_V387.md`.
Ledger: `CHECKLIST_V387.md`.
...
rank. Imposing both conditions (`stageonenull_v387.py`, block-resampled
...
**New measurements.**
- Standard occurrence metrics (`occurrence_v387.py`): Transmitter Rate
...
- RFI vetting (`rfi_v387.py`): 0 same-channel coincidences with unrelated
...
**Two process defects, both now gated:** `occurrence_v387.py` silently
overwrote `survey_numbers_round47.tex`, which `stageonenull_v387.py` owns,
