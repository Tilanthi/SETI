...
\caption{Distance distribution of the full 120-star volume-limited
sample (median 14.1\,pc). The rising number of stars per distance bin
reflects the increasing shell volume with distance, moderated by the
declining fraction of the local stellar population with existing public
ALMA coverage.}
\label{fig:sample}
\end{figure}
