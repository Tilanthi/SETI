#!/usr/bin/env python3
"""v3.96: the radius-corrected statistic becomes the PRIMARY analysis.
...
What this generator produces:
 ...
 2. The correctly conditioned null for the CORRECTED statistic. A stage-1
    ...
    pseudo-star tail factor and -- new in v3.96, at referee 2's request --
...
json.dump(res, open(os.path.join(HERE, 'primary_v396.json'), 'w'), indent=1)

L = ['%% GENERATED by primary_v396.py -- do not hand-edit.\n']
