#!/usr/bin/env python3
"""R2-2 (v3.96): the standard occurrence-rate metrics, computed.
...
json.dump(res, open(os.path.join(HERE, 'occurrence_v396.json'), 'w'),
...
L = ['%% generated by occurrence_v396.py -- do not edit\n']
