# BUILD NOTES — v3.96: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V396.md` is the live ledger.
...
New `primary_v396.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v396.txt` ships the verbatim output of
