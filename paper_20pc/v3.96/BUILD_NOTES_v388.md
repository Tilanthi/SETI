# BUILD NOTES — v3.96: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v396.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v396.tex` |
...
* **The rename `v387` → `v396` left `tab_falsealarm_v387.tex` orphaned.**
