...
# too. Missing this shipped four rows of the v3.96 false-alarm table as
# "--": falsealarm_v396.py looks its inputs up by name with V('Name'), and
# occurrence_v396.py cross-asserts against published values the same way.
