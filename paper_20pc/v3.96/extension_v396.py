#!/usr/bin/env python3
"""v3.96: the prospective epoch extension.
...
json.dump(res, open(os.path.join(HERE, 'extension_v396.json'), 'w'),
          indent=1, default=str)

L = ['%% GENERATED by extension_v396.py -- do not hand-edit.\n']
...
open(os.path.join(HERE, 'tab_extension_v396.tex'), 'w').write('\n'.join(T) + '\n')

print('%s: %d macros; tab_extension_v396.tex written'
