...
folder, and this file was not kept up. Noted at v3.96 rather than
reconstructed, since the per-version notes are the primary record and are
complete.

## v3.96 (2026-09-21) — two referee reports, 26 recommendations, none declined

Full notes: `BUILD_NOTES_v396.md`. Letter: `REFEREE_RESPONSE_V396.md`.
Ledger: `CHECKLIST_V396.md`.
...
rank. Imposing both conditions (`stageonenull_v396.py`, block-resampled
...
**New measurements.**
- Standard occurrence metrics (`occurrence_v396.py`): Transmitter Rate
...
- RFI vetting (`rfi_v396.py`): 0 same-channel coincidences with unrelated
...
**Two process defects, both now gated:** `occurrence_v396.py` silently
overwrote `survey_numbers_round47.tex`, which `stageonenull_v396.py` owns,
...
## v3.96 (2026-09-22) — the prospective epoch extension

Full notes: `BUILD_NOTES_v396.md`.
...
Traps: the v387->v396 rename orphaned `tab_falsealarm_v387.tex` and only
