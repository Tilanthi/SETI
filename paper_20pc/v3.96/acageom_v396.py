#!/usr/bin/env python3
"""R2-M3 (v3.96): what actually causes the stellar-rank displacement.
...
Writes survey_numbers_round61.tex and acageom_v396.json.
"""
import csv
import json
import math
...
L = ['%% GENERATED by acageom_v396.py -- do not hand-edit.\n']
...
json.dump(dict(prof_12m=res['12m'], prof_7m=res['7m'], nwin=nwin,
          ...
          open(os.path.join(HERE, 'acageom_v396.json'), 'w'), indent=1)
