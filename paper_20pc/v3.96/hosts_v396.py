#!/usr/bin/env python3
"""R2-4 (v3.96): activity and multiplicity status of the four unattributed
stage-1 hosts.
...
queried once on 2026-09-22 and FROZEN into hosts_v396.json so the build
...
Writes survey_numbers_round58.tex and tab_hosts_v396.tex.
"""
import json
import os
import sys
...
FROZEN = os.path.join(HERE, 'hosts_v396.json')
OUT = os.path.join(HERE, 'survey_numbers_round58.tex')
TAB = os.path.join(HERE, 'tab_hosts_v396.tex')
...
with open(TAB, 'w') as f:
    f.write('%% GENERATED by hosts_v396.py -- do not hand-edit.\n')
...
print('hosts_v396: %d of %d hosts carry activity indicators, %d multiplicity'
