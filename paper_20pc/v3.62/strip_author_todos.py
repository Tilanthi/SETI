...
TEX = 'technosignatures_40pc_v3.62.tex'
...
BLOCKS = [
    ...
    ('A2', 'The execution-block overlap with White (2026)',
     ...
     "Sec. 2, the paragraph on the pilot's superseded products"),
    ...
    ('A7', 'The submission git tag (NOTE: the block still names submitted-v3.32 '
     'in a v3.54 manuscript, so the tag name itself needs the authors decision)',
