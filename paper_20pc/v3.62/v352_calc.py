...
Inputs (all frozen; all in this directory unless noted):
  ...
  per_target_results_v3.62.csv    the released catalogue (431 windows)
  ...
  technosignatures_40pc_v3.62.tex parsed, read-only, for the transfer bracket
...
CATALOGUE_FILE = 'per_target_results_v3.62.csv'
