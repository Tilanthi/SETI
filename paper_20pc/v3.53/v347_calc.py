...
-------
  ...
  per_target_results_v3.53.csv the released catalogue (431 windows).
...
ROWS = list(csv.DictReader(open('per_target_results_v3.53.csv')))
...
# The grid over-count, DERIVED rather than asserted (referee C2, v3.53).  Up to
