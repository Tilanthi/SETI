# BUILD NOTES — v3.99: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v399.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v399.tex` |
...
* **The rename `v387` → `v399` left `tab_falsealarm_v387.tex` orphaned.**
