...
# v3.99: superseded. v381_calc.py emits this from the catalogue's
...
_C = 2.99792458e8
# The aperture efficiency here must be the one the text says is QUOTED. The
# benchmark paragraph gives both a perfect aperture (eta = 1, 8.4e14 W) and a
# realistic one (eta = 0.7, 5.9e14 W) and then states that the realistic case
# is the one quoted -- but this ratio was computed against the perfect
# aperture, so the paper divided its quoted median by a benchmark it had just
# said it was not using. The printed numbers 1.9e15 and 5.9e14 give 3.2; the
# paper said 2.3.
BENCH_D, BENCH_PTX, BENCH_NU, BENCH_ETA = 12.0, 1.0e6, 230.0e9, 0.7
_lam = _C / BENCH_NU
