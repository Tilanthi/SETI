...
``interesting'' systems, our sample of 120 stars is constructed to be
representative of the general stellar population in the immediate solar
neighbourhood, irrespective of spectral type, age, multiplicity, or known
planetary or circumstellar-disc status. We mine the ALMA archive
...
\caption{Cumulative distance distribution of the full 120-star
volume-limited sample: the total number of stars with distance less than
$d$, as a function of $d$ (median 14.1\,pc). The steepening of the curve
with increasing distance reflects the increasing shell volume at larger
$d$, moderated by the declining fraction of the local stellar population
with existing public ALMA coverage.}
\label{fig:sample}
\end{figure}
