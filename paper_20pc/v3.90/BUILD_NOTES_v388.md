# BUILD NOTES — v3.90: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v390.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v390.tex` |
...
* **The rename `v387` → `v390` left `tab_falsealarm_v387.tex` orphaned.**
