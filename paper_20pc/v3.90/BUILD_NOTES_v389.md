# BUILD NOTES — v3.90: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V390.md` is the live ledger.
...
New `primary_v390.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v390.txt` ships the verbatim output of
