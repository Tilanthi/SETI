...
folder, and this file was not kept up. Noted at v3.90 rather than
reconstructed, since the per-version notes are the primary record and are
complete.

## v3.90 (2026-09-21) — two referee reports, 26 recommendations, none declined

Full notes: `BUILD_NOTES_v390.md`. Letter: `REFEREE_RESPONSE_V390.md`.
Ledger: `CHECKLIST_V390.md`.
...
rank. Imposing both conditions (`stageonenull_v390.py`, block-resampled
...
**New measurements.**
- Standard occurrence metrics (`occurrence_v390.py`): Transmitter Rate
...
- RFI vetting (`rfi_v390.py`): 0 same-channel coincidences with unrelated
...
**Two process defects, both now gated:** `occurrence_v390.py` silently
overwrote `survey_numbers_round47.tex`, which `stageonenull_v390.py` owns,
...
## v3.90 (2026-09-22) — the prospective epoch extension

Full notes: `BUILD_NOTES_v390.md`.
...
Traps: the v387->v390 rename orphaned `tab_falsealarm_v387.tex` and only
