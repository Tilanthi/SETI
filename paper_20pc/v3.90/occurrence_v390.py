#!/usr/bin/env python3
"""R2-2 (v3.90): the standard occurrence-rate metrics, computed.
...
json.dump(res, open(os.path.join(HERE, 'occurrence_v390.json'), 'w'),
...
L = ['%% generated by occurrence_v390.py -- do not edit\n']
