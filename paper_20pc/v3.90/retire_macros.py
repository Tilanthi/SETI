...
# too. Missing this shipped four rows of the v3.90 false-alarm table as
# "--": falsealarm_v390.py looks its inputs up by name with V('Name'), and
# occurrence_v390.py cross-asserts against published values the same way.
