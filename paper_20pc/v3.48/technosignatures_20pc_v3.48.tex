...
$M_{\rm CO}<\CoMassLo$--$\CoMassHi\times10^{19}$\,kg in optically thin LTE. A split-half of
...
budget of \S\ref{sec:sample} took one block per unit. The unit behind the Band~3 flag holds
...
\texttt{per\_target\_results\_v3.48.csv}, carries \NCatRows{} rows, one per searched window, in \NCatCols{}
