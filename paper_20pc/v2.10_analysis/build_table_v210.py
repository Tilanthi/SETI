...
d = json.load(open('/workspace/SETI/paper_20pc/paper_v210_raw.json'))
...
SPTYPE = {
    ...
    "* g Lup": "F5V$^\\dagger$",
    # New this version (v2.10): recovered via the proper-motion crossmatch
    # fix (Barnard's Star, Wolf 359) or the legacy-calibration-replay /
    # stale-marker recoveries (Wolf 219, chi01 Ori, eta Cru, CD-38 10980,
    # GL 3379) -- see Results for the recovery-mechanism narrative.
    "* chi01 Ori": "G0V",
    "* eta Cru": "F2V",
    "Wolf  219": "M dwarf$^\\ddagger$",
    "CD-38 10980": "M dwarf$^\\ddagger$",
    "GL 3379 (Gaia DR3 3316364602541746048)": "M4V$^\\dagger$",
    "LHS 1140": "M4.5V",
    "HN Lib": "M4V",
}
DISPLAY = {
...
json.dump(rows, open('/workspace/SETI/paper_20pc/paper_v210_rows.json','w'), indent=1, default=str)
