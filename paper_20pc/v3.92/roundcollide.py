...
Written after an occurrence-rate generator added in the v3.92 cycle
silently overwrote survey_numbers_round47.tex, which stageonenull_v392.py
...
for fn in sorted(os.listdir(HERE)):
    ...
    for mm in PAT.finditer(src):
        ...
        # round file -- viscal_v392.py reads round38 to recombine the
