# BUILD NOTES — v3.92: the radius correction fails its own validation
...
Both are fixed, and a new gate, `consistency_v392.py`, now asserts that
...
to do if it failed. New `radval_v392.py` does exactly that on
