# BUILD NOTES — v3.92: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V392.md` is the live ledger.
...
New `primary_v392.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v392.txt` ships the verbatim output of
