...
# too. Missing this shipped four rows of the v3.92 false-alarm table as
# "--": falsealarm_v392.py looks its inputs up by name with V('Name'), and
# occurrence_v392.py cross-asserts against published values the same way.
