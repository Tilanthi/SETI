# BUILD NOTES — v3.92: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v392.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v392.tex` |
...
* **The rename `v387` → `v392` left `tab_falsealarm_v387.tex` orphaned.**
