...
Inputs (all frozen; all in this directory unless noted):
  ...
  per_target_results_v3.71.csv    the released catalogue (431 windows)
  ...
  technosignatures_40pc_v3.71.tex parsed, read-only, for the transfer bracket
...
F = float
ROWS = list(csv.DictReader(open(os.path.join(HERE, 'per_target_results_v3.71.csv'))))
...
CATALOGUE_FILE = 'per_target_results_v3.71.csv'
