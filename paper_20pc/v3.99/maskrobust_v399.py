#!/usr/bin/env python3
"""R2-5 (v3.99): robustness of the dispositions to the line-mask half-width,
as a table.
...
(falsealarm_v399.py, primary_v399.py, make_vistest_events_v385.py all test
...
Writes survey_numbers_round59.tex and tab_maskrobust_v399.tex.
"""
import csv
import os
...
TAB = os.path.join(HERE, 'tab_maskrobust_v399.tex')
...
with open(TAB, 'w') as f:
    f.write('%% GENERATED by maskrobust_v399.py -- do not hand-edit.\n')
