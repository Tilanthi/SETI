# BUILD NOTES — v3.99: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V399.md` is the live ledger.
...
New `primary_v399.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v399.txt` ships the verbatim output of
