...
# =====================================================================
# v4.01 (R1-9): MOVED to make_fig_accel2d.py.  The fraction is a function of
# the planet's maximum line-of-sight acceleration and of the ceiling it is
# measured against, and both of those live there; computing it here meant
# hard-coding a_max = 4.00 "the value the manuscript quotes" and the two
# ceilings 12.0 and 13.3 Hz/s/GHz as literals, which is how the caption came
# to compare the planet against one ceiling under the other's name.
