...
DEFERRED = [
    dict(macros=['NStageOneWin', 'NVisTested'],
         owner='candidate-chain rewrite (R2-M1)',
         why='the visibility test covered 13 windows of which 11 are stage-1 '
             'in the released catalogue; the fits are being re-run on all 56'),
    dict(macros=['NStageOneUnattrib', 'NVisUnatt'],
         owner='candidate-chain rewrite (R2-M1)',
         why='the frozen vistest file still carries HD 14055 and HD 23484, '
             'which the ACA repair removed'),
    ...
    dict(macros=['VisHdFortyRe', 'FitHdFortyRe'],
         owner='R2-M5 residue: delete the single-channel estimator',
         why='R2-M2 row 5: two estimators reported under the same words'),
    dict(macros=['VisMaxReSig', 'FitUnattMaxAbs'],
         owner='R2-M5 residue: delete the single-channel estimator',
         why='R2-M2 row 7: and the 2.5 belongs to a retired window'),
    ...
    dict(macros=['ClustStageMean', 'PriMean'],
         owner='R2-M5.1: one chance expectation, one generator',
