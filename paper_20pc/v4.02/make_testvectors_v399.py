#!/usr/bin/env python3
"""R2-2 (v3.99): a known-answer test set that does NOT depend on this
...
OUT = os.path.join(HERE, 'testvectors_v399')
...
make_testvectors_v399.py from first principles -- Gaussian noise plus a
