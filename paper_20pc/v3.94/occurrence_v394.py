#!/usr/bin/env python3
"""R2-2 (v3.94): the standard occurrence-rate metrics, computed.
...
json.dump(res, open(os.path.join(HERE, 'occurrence_v394.json'), 'w'),
...
L = ['%% generated by occurrence_v394.py -- do not edit\n']
