# BUILD NOTES — v3.94: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V394.md` is the live ledger.
...
New `primary_v394.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v394.txt` ships the verbatim output of
