...
CAT = 'per_target_results_v3.94.csv'
...
ax = axes[0]
# R2-5 (v3.94): the systematic budget, shown rather than tabulated. The
...
ax = axes[1]
# R1-7 (v3.94): confirmation power, not block count. Classes come from
# epochsplit_v394.py, which defines an independent epoch as a separation
# of more than one day.
import json as _json
_ep = _json.load(open('epochsplit_v394.json'))
