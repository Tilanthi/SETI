# BUILD NOTES — v3.94: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v394.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v394.tex` |
...
* **The rename `v387` → `v394` left `tab_falsealarm_v387.tex` orphaned.**
