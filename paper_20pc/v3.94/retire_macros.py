...
# too. Missing this shipped four rows of the v3.94 false-alarm table as
# "--": falsealarm_v394.py looks its inputs up by name with V('Name'), and
# occurrence_v394.py cross-asserts against published values the same way.
