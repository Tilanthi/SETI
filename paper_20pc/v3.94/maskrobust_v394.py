#!/usr/bin/env python3
"""R2-5 (v3.94): robustness of the dispositions to the line-mask half-width,
as a table.
...
(falsealarm_v394.py, primary_v394.py, make_vistest_events_v385.py all test
...
Writes survey_numbers_round59.tex and tab_maskrobust_v394.tex.
"""
import csv
import os
...
TAB = os.path.join(HERE, 'tab_maskrobust_v394.tex')
...
with open(TAB, 'w') as f:
    f.write('%% GENERATED by maskrobust_v394.py -- do not hand-edit.\n')
