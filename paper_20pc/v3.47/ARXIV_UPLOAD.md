...
0 underfull, 0 Type 3 fonts, 0 missing files, 30 pages.

**30 items** (23 tex/cls/sty + 7 figures).

## Source, class and macro inputs
- `technosignatures_20pc_v3.47.tex`
- `openjournal.cls`
- `epsf.sty`
- `survey_numbers.tex`
...
`per_target_results_v3.47.csv`, the frozen products (`*.json`), the
