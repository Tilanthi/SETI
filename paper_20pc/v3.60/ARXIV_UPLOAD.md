...
**44 items** (35 tex/cls/sty + 9 figures). The `.tex` carries no author
`%` comments; the outstanding author questions are in `AUTHOR_ACTIONS.md`.

Abstract: **1919 rendered characters** against arXiv's hard limit of 1920
(`abschars.py`, read back out of the PDF; `abstract_limit.py` gives 1907 from
source with macros expanded). One character of headroom — any further
abstract edit must be measured with both counters, not estimated.
...
- `tab_perband.tex`
- `tab_selection.tex`
- `technosignatures_20pc_v3.60.tex`
