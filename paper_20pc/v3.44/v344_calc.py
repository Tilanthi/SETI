#!/usr/bin/env python3
"""Round-14 (v3.44, referee cycle 2) generated numbers.
...
hand-typed is recomputed here from products shipped in this folder:
  ...
  per_target_results_v3.44.csv   the released catalogue (431 windows)
...
ROWS = list(csv.DictReader(open(HERE + '/per_target_results_v3.44.csv')))
