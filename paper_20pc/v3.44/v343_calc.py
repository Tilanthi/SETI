#!/usr/bin/env python3
"""Round-13 (v3.44) generated numbers.

Every quantity the three v3.44 referee reports showed to be hand-typed,
stale or contradicted by the shipped catalogue is recomputed here from
`per_target_results_v3.44.csv` (the released catalogue), the frozen export
...
CSV = HERE + '/per_target_results_v3.44.csv'
...
# Retired in the v3.44 cycle after the unused-macro sweep: AcaBeamRatio,
