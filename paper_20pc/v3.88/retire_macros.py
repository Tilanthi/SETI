...
# too. Missing this shipped four rows of the v3.88 false-alarm table as
# "--": falsealarm_v388.py looks its inputs up by name with V('Name'), and
# occurrence_v388.py cross-asserts against published values the same way.
