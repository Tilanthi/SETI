# BUILD NOTES — v3.88: the prospective epoch extension
...
| file | purpose |
|---|---|
| `extension_v388.py` | the extension's coverage, null, positive control → round 50 + `tab_extension_v388.tex` |
...
* **The rename `v387` → `v388` left `tab_falsealarm_v387.tex` orphaned.**
