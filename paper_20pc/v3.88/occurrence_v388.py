#!/usr/bin/env python3
"""R2-2 (v3.88): the standard occurrence-rate metrics, computed.
...
json.dump(res, open(os.path.join(HERE, 'occurrence_v388.json'), 'w'),
...
L = ['%% generated by occurrence_v388.py -- do not edit\n']
