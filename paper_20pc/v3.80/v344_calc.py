...
hand-typed is recomputed here from products shipped in this folder:
  ...
  archive_meta_v380.json         ALMA obscore + datalink harvest
...
ROWS = list(csv.DictReader(open(HERE + '/per_target_results_v3.80.csv')))
...
#
# v3.62 (referee 1, point 3).  `archive_meta_v380.json` was harvested from the
