...
-------
  ...
  archive_meta_v380.json       ALMA obscore + datalink harvest: progenitor
...
AM = json.load(open('archive_meta_v380.json'))
ROWS = list(csv.DictReader(open('per_target_results_v3.80.csv')))
