...
META = json.load(open('archive_meta_v380.json'))['ebs']
NWIN = len(ROWS)
...
_all = {l.strip() for l in open('searched_ebs_v380.txt') if l.strip()}
_frozen = {r['eb'] for r in ROWS}
_meta = json.load(open('archive_meta_v380.json'))['mous']
_prog = set()
