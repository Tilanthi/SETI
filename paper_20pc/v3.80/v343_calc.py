...
`per_target_results_v3.80.csv` (the released catalogue), the frozen export
...
CSV = HERE + '/per_target_results_v3.80.csv'
...
# release folder: `archive_meta_v380.json` (ALMA obscore + datalink harvest)
...
META = json.load(open(HERE + '/archive_meta_v380.json'))
