# Author actions outstanding for the v3.66 submission
...
## A8. The page budget — RESOLVED BY THE AUTHORS, 2026-09-13: accept 32 pages

The paper is **32 pages, 31.39 pp of content**; page 32 carries bibliography
only. The 31-page target was the authors' own budget rather than a journal
limit, and after three further rounds of internal review — each of which added
referee-required material and paid some of it back — the authors have accepted
32 pages. The two structural alternatives (moving §5.5 and Table 10 into
Appendix H, or deleting Appendix I) are **not** taken; both reversed an earlier
referee's request, and neither is needed now.

**Action for the cover letter**: state that the length is 32 pages and that the
additions since the previous version are referee-required, listing the
principal ones — the array-split robustness table, the leave-one-star-out
cross-validation, the solar-system crossmatch, the combined sensitivity debit,
the recurrence-coverage statement and four software citations.

## A9. The commitment to request a new ALMA epoch of CP-72 2713 (referee 2, M3)
