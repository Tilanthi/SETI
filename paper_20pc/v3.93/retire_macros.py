...
# too. Missing this shipped four rows of the v3.93 false-alarm table as
# "--": falsealarm_v393.py looks its inputs up by name with V('Name'), and
# occurrence_v393.py cross-asserts against published values the same way.
