# BUILD NOTES — v3.93: the radius-corrected statistic becomes primary
...
each needs; `CHECKLIST_V393.md` is the live ledger.
...
New `primary_v393.py` reruns candidate selection and computes the
...
* **R2-m3** — `REFEREE_VERIFICATION_v393.txt` ships the verbatim output of
