...
CAT = 'per_target_results_v3.93.csv'
...
ax = axes[0]
# R2-5 (v3.93): the systematic budget, shown rather than tabulated. The
...
ax = axes[1]
# R1-7 (v3.93): confirmation power, not block count. Classes come from
# epochsplit_v393.py, which defines an independent epoch as a separation
# of more than one day.
import json as _json
_ep = _json.load(open('epochsplit_v393.json'))
